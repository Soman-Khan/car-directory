...
<div class="container archieve-page "  >
	  <div class="direc-item">
		<div id="js-grid-meet-the-<?php echo esc_html($rand_div);?>" class="cbp cbp-l-grid-team" >
		  <?php
		$i=1;
...
$grid_col375=get_option('grid_col375');
	...
	wp_enqueue_script('iv_property-ar-script-filter'.$rand_div, wp_iv_property_URLPATH . 'admin/files/js/filter.js');
	wp_localize_script('iv_property-ar-script-filter'.$rand_div, 'realpro_filter', array(
