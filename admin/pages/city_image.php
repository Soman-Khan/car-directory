...
?>
<h3  class=""><?php  esc_html_e('Cities Images','ivproperty'); ?>  <small><?php  esc_html_e('[Cities will get from your listings]','ivproperty'); ?> </small>	
</h3>
<br/>
	...
	<div class="row ">
		<div class="col-md-12 ">
			<table class="table table-bordered table-hover table-responsive">												  
			  <thead>
					<tr>
						<th><?php  esc_html_e('City Name','ivproperty'); ?>  </th>			
						<th><?php  esc_html_e('City Image','ivproperty'); ?> </th>
					</tr>
				</thead>
			  <tbody>			 
					<?php		
							...
							foreach($get_cityies as $row1){
								...
								<tr>							  
									<th>				
										...
										<input type="hidden" name="<?php echo str_replace(' ','-',strtolower($row1));?>" value="<?php echo str_replace(' ','-',strtolower($row1));?>">
									</th>					
									<th> 
										...
										<?php   esc_html_e('Set Image','ivproperty');?> </button>
									</th>
								</tr>
								<?php
								}
