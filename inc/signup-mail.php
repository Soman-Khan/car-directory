<?php
global $wpdb;			
	$email_body = get_option( 'iv_property_signup_email');
	$signup_email_subject = get_option( 'iv_property_signup_email_subject');			
	...
	if(get_option('iv_property_mailchimp_api_key')!=""){						
			$firstname='';
			$lastname='';
			$words= array();
			...
			$list_id=get_option('iv_property_mailchimp_list');
