...
global $wpdb;	
	...
	$email_body = get_option( 'iv_property_contact_email');
	$contact_email_subject =  esc_html__( 'New listing added', 'ivproperty' ); 
	$message =  esc_html__( 'New listing added to your site. You can publish or delete from your site dashboard', 'ivproperty' ); 
