<?php
  ...
  ';
  // For Template ****
  update_option('iv_property_order_admin_email', $admin_order_email_template  ); 
  update_option('iv_property_order_client_email', $client_order_email_template  ); 
  // For Subject ****
  $order_subject = get_bloginfo().': New Order';
  update_option('iv_property_order_admin_email_sub', $order_subject ); 
  $order_subject = get_bloginfo().': Order Confirm'; 
update_option('iv_property_order_client_email_sub', $order_subject  ); 