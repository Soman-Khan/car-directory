<?php
  ...
  text-align:center;
	...
	';
	// For Template ****
	update_option('iv_property_reminder_email', $reminder_email_template  ); 
	// For Subject ****
	$reminder_subject = get_bloginfo().': Subscription Reminder ';
	update_option('iv_property_reminder_email_subject', $reminder_subject ); 
update_option('iv_property_reminder_day', '10'); 